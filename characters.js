window.CHARACTERS = [
  {
    ...
    gender: "♂",
    height: "217cm",
    personality: ["ISTJ","침묵","관찰","섬세","책임감","감정변화 적음"],
    appearance: [
      "밝은 피부",
      "흑발 매우 긴 장발",
      "흑안",
...

  {
    ...
    gender: "♂",
    height: "215cm",
    personality: ["ESTP","호기심","능글","발칙","노련","농염"],
    appearance: [
      "밝은 피부",
      "새하얀 매우 긴 장발",
      "흑안",
...

  {
    ...
    gender: "♂",
    height: "187cm",
    personality: ["INT(F)P","내향","차가움","시니컬","독설","무관심"],
    appearance: [
      "밝은 피부",
      "남색 칼단발 + 일자 앞머리",
      "푸른 눈",
...

  {
    ...
    gender: "♂",
    height: "160~220cm",
    personality: ["ES(N)FP","다정","애교","친화","사교","조건부 성숙"],
    appearance: [
      "밝은 피부",
      "흑발 짧은 머리",
      "적안",
...

  {
    ...
    gender: "♂",
    height: "185cm",
    personality: ["ES(N)TJ","외향","자기애","과시","승부욕","직설","탐미"],
    appearance: [
      "밝은 피부",
      "긴 갈색머리 하나로 묶음",
      "보라색 눈",
